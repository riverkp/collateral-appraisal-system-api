...
public class LandAppraisalDetailConfiguration : IEntityTypeConfiguration<LandAppraisalDetail>
{
    public void Configure(EntityTypeBuilder<LandAppraisalDetail> builder)
    {
        ...
        builder.OwnsOne(p => p.LandLocationDetail, location =>
        {
            location.Property(p => p.LandLocation)
                .UseCodeConfig()
                .HasColumnName("LandLocation");

            location.Property(p => p.LandCheck)
                .UseCodeConfig()
                .HasColumnName("LandCheck");

            location.Property(p => p.LandCheckOther)
                .UseMaxLengthNVarcharConfig()
            ...
            location.Property(p => p.Village)
                .UseLongStringConfig()
                .HasColumnName("Village");

            location.Property(p => p.Location)
                .UseMultiSelectConfig()
                .HasColumnName("Location");
        });

        builder.OwnsOne(p => p.LandFillDetail, fill =>
        {
            fill.Property(p => p.LandFill)
                .UseMultiSelectConfig()
            ...
            fill.Property(p => p.SoilLevel)
                .UseMeasurementConfig()
                .HasColumnName("SoilLevel");
        });

        builder.OwnsOne(p => p.LandAccessibilityDetail, detail =>
        {
            detail.OwnsOne(p => p.FrontageRoad, road =>
            {
            ...
            detail.Property(p => p.RoadSurface)
                .UseCodeConfig()
                .HasColumnName("RoadSurface");

            detail.Property(p => p.RoadSurfaceOther)
                .UseMaxLengthNVarcharConfig()
                .HasColumnName("RoadSurfaceOther");

            detail.Property(p => p.PublicUtility)
                .UseMultiSelectConfig()
                .HasColumnName("PublicUtility");

            detail.Property(p => p.PublicUtilityOther)
                .UseMaxLengthNVarcharConfig()
                .HasColumnName("PublicUtilityOther");

            detail.Property(p => p.LandUse)
                .UseMultiSelectConfig()
                .HasColumnName("LandUse");

            detail.Property(p => p.LandUseOther)
                .UseMaxLengthNVarcharConfig()
                .HasColumnName("LandUseOther");

            detail.Property(p => p.LandEntranceExit)
                .UseMultiSelectConfig()
                .HasColumnName("LandEntranceExit");

            detail.Property(p => p.LandEntranceExitOther)
                .UseMaxLengthNVarcharConfig()
                .HasColumnName("LandEntranceExitOther");

            detail.Property(p => p.Transportation)
                .UseMultiSelectConfig()
                .HasColumnName("Transportation");

            detail.Property(p => p.TransportationOther)
                .UseMaxLengthNVarcharConfig()
                .HasColumnName("TransportationOther");
        });

        builder.Property(p => p.AnticipationOfProp)
            .UseMultiSelectConfig();

        builder.OwnsOne(p => p.LandLimitation, limitation =>
        {
            limitation.OwnsOne(p => p.Expropriation, expropriation =>
            {
            ...
            limitation.OwnsOne(p => p.Encroachment, encroachment =>
            {
            ...
            limitation.Property(p => p.Electricity)
                .UseCodeConfig()
                .HasColumnName("Electricity");

            limitation.Property(p => p.ElectricityDistance)
                .UseMeasurementConfig()
                .HasColumnName("ElectricityDistance");

            limitation.Property(p => p.IsLandlocked)
                .HasColumnName("IsLandlocked");

            limitation.Property(p => p.IsLandlockedRemark)
                .UseMaxLengthNVarcharConfig()
                .HasColumnName("IsLandlockedRemark");

            limitation.OwnsOne(p => p.ForestBoundary, boundary =>
            {
            ...
            limitation.Property(p => p.LimitationOther)
                .UseMaxLengthNVarcharConfig()
                .HasColumnName("LimitationOther");
        });

        builder.Property(p => p.Eviction)
            .UseMultiSelectConfig();

        builder.Property(p => p.Allocation)
            .UseCodeConfig();

        builder.OwnsOne(p => p.ConsecutiveArea, area =>
        {
        ...
        builder.OwnsOne(p => p.LandMiscellaneousDetail, detail =>
        {
            detail.Property(p => p.PondArea)
                .UseMeasurementConfig()
                .HasColumnName("PondArea");

            detail.Property(p => p.DepthPit)
                .UseMeasurementConfig()
                .HasColumnName("DepthPit");

            detail.Property(p => p.HasBuilding)
                .UseCodeConfig()
                .HasColumnName("HasBuilding");

            detail.Property(p => p.HasBuildingOther)
                .UseMaxLengthNVarcharConfig()
