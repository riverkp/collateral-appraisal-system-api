...
public class CollateralCondoConfiguration : IEntityTypeConfiguration<CollateralCondo>
{
    public void Configure(EntityTypeBuilder<CollateralCondo> builder)
    {
        ...
        builder.Property(p => p.CondoName)
            .UseLongStringConfig();
        ...
        builder.Property(p => p.CondoRegisNo)
            .UseVeryShortStringConfig();

        builder.Property(p => p.RoomNo)
            .UseTinyStringConfig();
        ...
        {
            coordinate.Property(p => p.Latitude)
                .UseLatLonConfig()
                .HasColumnName("Latitude");

            coordinate.Property(p => p.Longitude)
                .UseLatLonConfig()
