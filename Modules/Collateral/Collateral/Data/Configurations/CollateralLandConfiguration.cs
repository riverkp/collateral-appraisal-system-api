...
public class CollateralLandConfiguration : IEntityTypeConfiguration<CollateralLand>
{
    public void Configure(EntityTypeBuilder<CollateralLand> builder)
    {
        ...
        builder.OwnsOne(p => p.Coordinate, coordinate =>
        {
        ...
        builder.OwnsOne(p => p.CollateralLocation, location =>
        {
            location.Property(p => p.SubDistrict).UseMediumStringConfig().HasColumnName("SubDistrict");
            location.Property(p => p.District).UseMediumStringConfig().HasColumnName("District");
            location.Property(p => p.Province).UseMediumStringConfig().HasColumnName("Province");
